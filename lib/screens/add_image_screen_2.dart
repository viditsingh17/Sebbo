...
class AddImage2 extends StatefulWidget {
  static const String addImage2Route = '/home/add_image_2';
  const AddImage2({Key key}) : super(key: key);

  @override
  _AddImage2State createState() => _AddImage2State();
}

class _AddImage2State extends State<AddImage2> {
