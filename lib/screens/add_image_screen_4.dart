...
class AddImage4 extends StatefulWidget {
  static const String addImage4Route = '/home/add_image_4';
  const AddImage4({Key key}) : super(key: key);

  @override
  _AddImage4State createState() => _AddImage4State();
}

class _AddImage4State extends State<AddImage4> {
        ...
        children: [
          ...
          myRaisedButton(
            ...
            onPressed: () {
              ...
              // createFirebase();
              // Navigator.of(context).pushNamed(AddImage3.addImage3Route);
            },
          ),
        ],
      ),
